...
function GameBoyCore(canvas, ROMImage) {
	...
	this.colors = [0xFFFFFF, 0xAAAAAA, 0x333333, 0x000000];			//"Classic" GameBoy palette colors.
	this.colors = [0x000000, 0x333333, 0xFF0000, 0xFFFFFF];			//"Classic" GameBoy palette colors.
